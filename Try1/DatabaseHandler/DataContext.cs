...
namespace DatabaseHandler
{
    ...
    public class DataContext
    {
        ...
        private DataContext() // Местонахождение файла.
        {
        ...
        public void Initialize() // Инициализация данных.
        {
        ...
        private void LoadDataContext() // Загрузка данных из файла.
        {
        ...
        public void ForceClearDatabase() // Сброс данных до дефолтного значения.
        {
            if (File.Exists(Path))
                File.Delete(Path);
        ...
        private void InitializeContext() // Загрука стандартной базы.
        {
            Pictures = new List<Picture>()
            {
            ...
            var auctionItem2 = new AuctionItem() { Art = Pictures[5], Price = 700 };
            var auctionItem3= new AuctionItem() { Art = Pictures[3], Price = 900 };
            var auctionItem4 = new AuctionItem() { Art = Pictures[12], Price = 2700 };
            var auctionItem5 = new AuctionItem() { Art = Pictures[9], Price = 150 };
            Auctions = new List<Auction>()
            {
                new Auction() {Title = "Under the tree", Date = new DateTime(2016,5,25), Items = { auctionItem, auctionItem2, auctionItem5 } },
                new Auction() {Title = "Chestnut tree", Date = new DateTime(1997, 8, 15), Items = { auctionItem3, auctionItem4 }
        }
            };
        ...
        public void SaveDataContext() // Сохранение даных.
        {
            BinaryFormatter binaryFormatter = new BinaryFormatter();
        ...
        private bool CheckIfDataExists() // Проверка на наличие файла.
        {
            if (File.Exists(Path))
            {
                return true;
